...
class LichTrinhSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('lich_trinh')->insert([
            [
                'tieu_de' => "Ngày 1 - Đà Nẵng - Nội Bài (Hà Nội) – Hà Nội (Ăn trưa, tối)",
            ...
            [
                'tieu_de' => "Ngày 2 - Hà Nội – Ninh Bình – Tràng An – Bái Đính (Ăn 3 bữa))",
            ...
            [
                'tieu_de' => "Ngày 3 - Hạ Long – Động Thiên Cung (Ăn 3 bữa))",
                ...
                'tieu_de' => "Ngày 4 - Hạ Long – Sân Bay Nội Bài – Đà Nẵng (Ăn sáng, trưa)",
