...
const LayoutAdmin = () => {
        ...
        <div>
            ...
            <Layout className="h-screen ">
                ...
                <Sider trigger={null} collapsible collapsed={collapsed}>
                 ...
                 <div className="  flex">
                    <p className="ml-11 text-white font-medium text-lg font-sans">Poly Tour</p>
                 </div>
                    <Menu
                        theme="dark"
                        mode="inline"
                    ...
                    >
                        ...
                        <Menu.SubMenu key="2" icon={<FaLuggageCart />} title="Tour du lịch">
                            ...
                            <Menu.SubMenu icon={<MdDiscount />  } key="2-9" title="Quản lý mã giảm giá">
                                <Menu.Item key="2-9-1">
                            ...
                            <Menu.SubMenu  icon={<FaShoppingCart />}  key="3" title={
 ...
 {usersId && (
            ...
            />
            <p className="mr-5">{usersId.name}</p>
