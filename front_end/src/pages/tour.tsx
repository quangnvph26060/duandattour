...
const TourPage: React.FC = () => {
  ...
  const totalResults = tourdiemden.length;
  ...
  const handleRadioChange = (e) => {
    ...
    console.log(selected); // Output: the selected value
      ...
      <div className="container mx-auto px-10 gap-11 pt-5">
        ...
        <article>
          ...
          <div className="flex gap-3 bg-white shadow-xl rounded-sm py-5">
            ...
            <div>
              <input
                ...
                id="sortAZ"
                value="sortAZ"
                checked={selectedValue === "sortAZ"}
                onChange={handleRadioChange}
              />
              <label htmlFor="sortAZ">Tên A - Z</label>
            </div>
            ...
            <div>
              <input
                ...
                id="sortZA"
                value="sortZA"
                checked={selectedValue === "sortZA"}
                onChange={handleRadioChange}
              />
              <label htmlFor="sortZA">Tên Z - A</label>
            </div>
            ...
            <div>
              <input
                ...
                id="sortPriceAsc"
                value="sortPriceAsc"
                checked={selectedValue === "sortPriceAsc"}
                onChange={handleRadioChange}
              />
              <label htmlFor="sortPriceAsc">Giá tăng dần</label>
            </div>
            ...
            <div>
              <input
                ...
                id="sortPriceDesc"
                value="sortPriceDesc"
                checked={selectedValue === "sortPriceDesc"}
                onChange={handleRadioChange}
              />
                  ...
                  <div className="bg-white rounded-t-lg shadow-xl">
                    ...
                    <div className="grid grid-cols-2 justify-between px-4 p-1">
                      <p className="text-xl font-bold text-red-500">
                        {formatCurrency(items.gia_nguoilon)}{" "}
                      </p>
          ...
          <div className="flex justify-center mt-5">
            <button
              className={`mx-2 px-3 py-1 rounded-md border font-bold hover:bg-blue-500 hover:text-white ${
            ...
            <button
              className={`mx-2 px-3 py-1 rounded-md border font-bold hover:bg-blue-500 hover:text-white ${
                currentPage === totalPages ? "bg-gray-300" : "hover:bg-blue-200"
              }`}
