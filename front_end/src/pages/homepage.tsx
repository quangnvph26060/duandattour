...
import lich from "../img/calendar.png";
...
const HomePage = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4">
      ...
      <div
        className="bg-white box-shadow rounded-lg  p-9 mx-auto pt-[200px] pb-[50px] relative h-full  translate-y-[-50%] z-50"
        style={{ maxWidth: "1100px" }}
      >
        <div className="tour-form mt-2 flex items-center gap-5 ">
