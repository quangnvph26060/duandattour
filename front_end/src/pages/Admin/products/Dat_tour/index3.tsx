...
import { useGetListBookingTourPaidQuery, useGetQuanlydattourQuery } from "../../../../api/qlydattour";
...
const ADmin_Qlytourdathanhtoan = (props: Props) => {
  ...
  // 1 useGetdattour
  const { data: Data, refetch } = useGetListBookingTourPaidQuery();
  ...
  return (
    <div>
      <header className="mb-4 flex justify-between items-center">
        <h2 className="font-bold text-2xl">Đơn đã thanh toán </h2>
      </header>
