...
import { useGetPermissionsQuery, useEditPermissionsMutation ,useAddPermissionsMutation} from '../../../../api/UserApi';
...
const Admin_Acountkhachhang_Permisssions: React.FC = () => {
    ...
    useEffect(() => {
      if (get_permission_via_role) {
        setSelectedRoles(get_permission_via_role.map(permission => permission.name));
      }
            ...
            return (
              <div className="form-check" key={permission.id}>
                <input
                  ...
                  type="checkbox"
                  name="permission[]"
                  checked={selectedRoles.includes(permission.name) 
                ...
                />
                <label className="form-check-label" htmlFor={permission.id.toString()}>
                  {permission.name}
                </label>
              </div>
            );
        ...
        <div className="container">
            ...
            >
                <Form.Item
                    ...
                    name="per"
                    rules={[
                        { required: true, message: 'Vui lòng nhập quyền !' },
                    ]}
                >
                    <Input />
